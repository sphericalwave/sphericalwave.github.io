...
<div class="sw-home">
  ...
  <div class="sw-home__grid sw-enter-2">
    <div class="sw-home__glass sw-home__card">
      ...
      <h3>Modeled in CAD</h3>
      <p>Layout, levels, and material quantities drawn before the dig. You sign off on the design, not a sketch on a napkin.</p>
    </div>
    <div class="sw-home__glass sw-home__card">
      <span class="sw-home__label">02</span>
      <h3>Critical-path schedule</h3>
      <p>Every task on a Gantt chart with its dependencies. You know what happens when, and what a rain day actually moves.</p>
    </div>
    <div class="sw-home__glass sw-home__card">
  ...
  <div class="sw-home__grid sw-enter-2">
    <div class="sw-home__glass sw-home__card">
      <span class="sw-home__label">Quality · fixed</span>
      <h3>Done right, every time</h3>
      <p>Quality isn't what gets cut to hit a number. Every job is designed and built to the same standard.</p>
    </div>
    <div class="sw-home__glass sw-home__card">
      <span class="sw-home__label">Price · low overhead</span>
      <h3>A fair number</h3>
      <p>Overheads are low, so you're paying for the work, not the business behind it. You get quality and price together.</p>
    </div>
    <div class="sw-home__glass sw-home__card">
      <span class="sw-home__label">Speed · your call</span>
      <h3>Fast costs more</h3>
      <p>Speed is the variable. A tight deadline means a bigger price; a flexible start date keeps it down. The Gantt chart shows you the trade-off.</p>
    </div>
  </div>
  ...
  <div class="sw-home__bento sw-enter-2">
    ...
    <div class="sw-home__glass sw-home__panel sw-home__panel--center">
      ...
      <p class="sw-home__panel-title">Software &amp; apps</p>
